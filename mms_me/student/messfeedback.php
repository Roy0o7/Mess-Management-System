            ...
            <div id="mid-content">
                   ...
                   <div class="post">
					...
					<?php if(isset($_REQUEST['success'])) echo "Your message was sent successfully";?>
                      <form id="messfeedback" action="sendmessage.php" method="post">
					  <p>Select Mess : 
						<select name="receiver" STYLE="width: 300px">
							<?php
							...
							{
								echo "<option value=\"{$mess['messid']}\" >{$mess['name']}</option>";
							}
							?>
						  Enter Message <br /> <textarea name="message" rows="10" cols="50" ></textarea>
						  <input type="hidden" name="sender" value="<?php echo $rollno;?>">
