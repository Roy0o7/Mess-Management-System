    	...
    	<div id="mid-wrap">
         ...
         <div id="side-wrap">
    	  ...
    	  <div id="mid">
			...
			$select_user_query="SELECT * FROM `mess`";
...
while($result=mysql_fetch_array($select_user))
	{ 
	echo "<tr><td>".$result['messid']."</td><td>".$result['name']."</td><td>".$result['owner']."</td><td>".$result['phoneno']."</td><td>".$result['emailid']."</td><td><a href =\"editmess.php?messid=".$result['messid']."\">Edit</a></td><td><a href =\"removemess.php?messid=".$result['messid']."\">Remove</a></td></tr>";
	} echo "</table>";
