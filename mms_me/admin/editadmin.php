<?php session_start();
		...
		if(isset($_REQUEST['editadmin_submit']))
		{
	...
	// add a toupper function here
			...
			$add_admin_query="UPDATE `mms`.`admin` SET `username` = '$newname', `address` = '$newaddress', `phoneno` = '$newphno', `emailid` = '$newemail' WHERE `admin`.`empcode` ='$empcode'";
			$add_admin=mysql_query($add_admin_query);
			header('Location: showadminlist.php?success=1');
    	  ...
    	  <div id="mid">
            ...
            <div id="mid-content">
                   ...
                   <div class="post">
                    ...
                    <h1 class="posttitle">
                      <a href="#"><?php echo "Add New Admin"; ?></a>
                    </h1>
                    <!-- /title -->
                    ...
                    <div class="postbody">
						<form id="editadmin_form" action="editadmin.php?empcode=<?php echo $_REQUEST['empcode'];?>" method="post">
							<table>
							<?php
							include("../connect.php");
							$sql_connect=mysql_connect($host,$user,$pass) or die("cannot connect to database.please try after sometime");
					...
					$countnot=$result2?mysql_num_rows($result2):0;
							$q="select * from `admin` where `empcode`='{$_REQUEST['empcode']}'";
							...
							?>
								<tr>
									<td>EMPCODE:</td>
									<td><b><?php echo $q_a['empcode']?></b></td>
								</tr>
								<tr>
									<td>EMPLOYEE NAME:</td>
									<td><input type="text" maxlength="20" name ="empname" value="<?php echo $q_a['username']?>"></td>
								</tr>
								<tr>
									<td>PHONE NUMBER:</td>
								...
								<tr>
									<td>EMAIL ID:</td>
									<td><input type="text" maxlength="50" name ="email" value="<?php echo $q_a['emailid']?>"></td>
								</tr>
								<tr>
									<td>ADDRESS:</td>
									<td><input type="text" maxlength="100" name ="address" value="<?php echo $q_a['address']?>"></td>
								</tr>
							</table>
							<center><input type="submit" value="Udate Admin Profile" name="editadmin_submit">
						</form>
                    </div>
