    	...
    	<div id="mid-wrap">
         ...
         <div id="side-wrap">
    	  ...
    	  <div id="mid">
			...
			$select_user_query="SELECT * FROM `admin`";
...
while($result=mysql_fetch_array($select_user))
	{ 
	if($result['empcode']!= $empcode)
	{echo "<tr><td>".$result['empcode']."</td><td>".$result['username']."</td><td>".$result['phoneno']."</td><td>".$result['emailid']."</td><td>".$result['address']."</td><td><a href =\"editadmin.php?empcode=".$result['empcode']."\">Edit</a></td><td><a href =\"removeadmin.php?empcode=".$result['empcode']."\">Remove</a></td></tr>";
	}} echo "</table>";
