         ...
         <div id="side-wrap">
    	  ...
    	  <div id="mid">
            ...
            <div id="header">
              ...
              <div id="tabs">
                <ul>
					<li><a href="resetstudentpass.php" class="active">Student</a></li>
            ...
            <div id="mid-content">
                   ...
                   <div class="post">
                    ...
                    <!-- title -->
						...
						<form id="select_stud" action="resetstudentpass.php" method="get">
						<p>Enter Roll Number : 
					...
					<?php
						...
						{	
							$query = "select * from student where rollno=\"{$_REQUEST['roll']}\"";
							...
							{
								echo '<a href=resetpass.php?utype=student&rollno='.$_REQUEST['roll'].'>Reset Password</a>';
							}	
						}
					?>
