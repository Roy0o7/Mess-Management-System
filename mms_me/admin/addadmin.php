<?php session_start();
	...
	// add a toupper function here
			...
			$add_admin_query="INSERT INTO `mms`.`admin` (`empcode`, `username`, `password`, `phoneno`, `address`, `emailid`) VALUES ('$newempcode', '$newname', '$newempcode', '$newphno', '$newaddress', '$newemail')";
    	  ...
    	  <div id="mid">
            ...
            <div id="mid-content">
                   ...
                   <div class="post">
                    ...
                    <div class="postbody">
						<form id="admin_form" action="addadmin.php" method="post">
							<?php if(isset($success)) echo "The admin was added successfully.<br />The passwork is same as the <b>EMPCODE</b>";?>
							<table>
								<tr>
									<td>EMPCODE:</td>
									<td><input type="text" maxlength="10" name = "empcode"></td>
								</tr>
								<tr>
									<td>EMPLOYEE NAME:</td>
									<td><input type="text" maxlength="20" name ="empname"></td>
								</tr>
								<tr>
									<td>PHONE NUMBER:</td>
							...
							<center><input type="submit" value="Add Admin" name="admin_submit">
						</form>
                    </div>
