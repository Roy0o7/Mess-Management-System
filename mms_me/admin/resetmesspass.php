            ...
            <div id="header">
              ...
              <div id="tabs">
                <ul>
					...
					<li><a href="resetmesspass.php"  class="active">Mess</a></li>
					<li><a href="resetadminpass.php">Admin</a></li>
	            </ul>
              </div>
              <!-- /top tabs -->
            ...
            <div id="mid-content">
                   ...
                   <div class="post">
                    ...
                    <!-- title -->
						...
						<form id="select_stud" action="resetmesspass.php" method="get">
						<p>Enter Mess ID : 
						<input type="text" name="messid" size = "9" value="<?php if(isset($_REQUEST['messid'])) echo $_REQUEST['messid']?>">
							<?php 
									include("../connect.php");
					...
					<?php
						...
						{	
							$query = "select * from mess where messid=\"{$_REQUEST['messid']}\"";
							$mess_select = mysql_query($query);
							echo '
							<table>
							<tr>
							 <td STYLE="width: 300px"><b>Mess ID</b></td>
							 <td STYLE="width: 300px"><b>Name of mess</b></td>
							 <td STYLE="width: 300px"><b>Owner</b></td>
							 <td STYLE="width: 300px"><b>Phone Number</b></td>
							 <td STYLE="width: 300px"><b>Email ID</b></td>
							 </tr> ';
							while($result=mysql_fetch_array($mess_select))
							{ 
							echo "<tr><td>".$result['messid']."</td><td>".$result['name']."</td><td>".$result['owner']."</td><td>".$result['phoneno']."</td><td>".$result['emailid']."</td></tr>";
							} echo "</table>";
							...
							{
								echo '<a href=resetpass.php?utype=mess&messid='.$_REQUEST['messid'].'>Reset Password</a>';
							}	
						}
					?>
