<?php session_start();
	...
	// add a toupper function here
			...
			$add_student_query= "INSERT INTO `mms`.`student` (`rollno`, `name`, `password`, `phoneno`, `hallno`, `roomno`, `dept`, `mailid`, `messid`) VALUES ('$newroll', '$newname', '$newpass', '$newphno', '$newhall', '$newroom', '$newdept', '$newemail', DUMMY)";
    	  ...
    	  <div id="mid">
            ...
            <div id="mid-content">
                   ...
                   <div class="post">
                    ...
                    <div class="postbody">
						<form id="admin_form" action="addstudent.php" method="post">
							<?php if(isset($success)) echo "The student was added successfully.<br />";?>
							<table>
								<tr>
									<td>ROLL NUMBER:</td>
									<td><input type="text" maxlength="10" name = "rollno"></td>
								</tr>
								<tr>
									<td>NAME:</td>
								...
								<tr>
									<td>HALL NUMBER</td>
									<td><input type="text" maxlength="1" name ="hall"></td>
								</tr>
								<tr>
									<td>Password</td>
									<td><input type="text" maxlength="10" name ="hall"></td>
								</tr>
								<tr>
									<td>ROOM NUMBER</td>
									<td><input type="text" maxlength="5" name ="room"></td>
								</tr>
								<tr>
									<td>DEPARTMENT</td>
									<td><input type="text" maxlength="50" name ="dept"></td>
								</tr>
								<tr>
									<td>EMAIL ID</td>
							...
							<center><input type="submit" value="Add Student" name="student_submit">
						</form>
                    </div>
