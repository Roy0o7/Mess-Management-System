    ...
    <div id="page-wrap2">
      ...
      <div id="page" class="with-sidebar">
       ...
       <div id="main-wrap">
    	  ...
    	  <div id="mid">
            ...
            <div id="header">
              ...
              <div id="tabs">
                <ul>
					...
					<li><a href="searchbyhall.php" class="active">Search By Hall</a></li>
	            </ul>
              </div>
              <!-- /top tabs -->
            ...
            <div id="mid-content">
                   ...
                   <div class="post">
                    ...
                    <div class="postbody">
					<!-- submission select for mess-->	
                    <form id="select_hall" action="searchbyhall.php" method="get">
					<p>Select Hall of Residence : 
					<select name="hall" STYLE="width: 100px">
						<?php
						...
						while($temp<9 )
						{
							...
							if((isset($_REQUEST['select_submit'])) && ($s==$temp))
							{
		...
		{
			$r=$_REQUEST['hall'];
			$select_user_query="SELECT * FROM `student` where `hallno`='$r'";
			...
			if($result)
			{
				...
				echo "<tr><td>".$result['rollno']."</td><td>".$result['name']."</td><td>".$result['hallno']."</td><td>".$result['dept']."</td><td>".$result['messid']."</td><td><a href =\"editstudent.php?rollno=".$result['rollno']."\">Edit</a></td><td><a href =\"removestudent.php?messid=".$result['rollno']."\">Remove</a></td></tr>";
