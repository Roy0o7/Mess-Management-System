         ...
         <div id="side-wrap">
    	  ...
    	  <div id="mid">
            ...
            <div id="header">
              ...
              <div id="tabs">
                <ul>
					<li><a href="resetstudentpass.php">Student</a></li>
					<li><a href="resetmesspass.php">Mess</a></li>
					<li><a href="resetadminpass.php" class="active">Admin</a></li>
	            </ul>
              </div>
              <!-- /top tabs -->
            ...
            <div id="mid-content">
                   ...
                   <div class="post">
                    ...
                    <!-- title -->
						...
						<form id="select_stud" action="resetadminpass.php" method="get">
						<p>Enter Emp Code : 
						<input type="text" name="empcode" size = "9" value="<?php if(isset($_REQUEST['empcode'])) echo $_REQUEST['empcode']?>">
							<?php 
									include("../connect.php");
						...
						<input type="submit" name ="select_submit" value="Show Details">
						</form>
					...
					<?php
						...
						if(isset($_REQUEST['select_submit'])||isset($_REQUEST['success']))
						{	
							$query = "select * from admin where empcode=\"{$_REQUEST['empcode']}\"";
							$admin_select = mysql_query($query);
							echo '
							<table>
							<tr>
							 <td STYLE="width: 300px"><b>EMP CODE</b></td>
							 <td STYLE="width: 300px"><b>Name</b></td>
							 <td STYLE="width: 300px"><b>Phone Number</b></td>
							 <td STYLE="width: 300px"><b>Email ID</b></td>
							 <td STYLE="width: 300px"><b>Address</b></td>
							</tr> ';
							while($result=mysql_fetch_array($admin_select))
							{ 
							echo "<tr><td>".$result['empcode']."</td><td>".$result['username']."</td><td>".$result['phoneno']."</td><td>".$result['emailid']."</td><td>".$result['address']."</td></tr>";
							} echo "</table>";
							...
							{
								echo '<a href=resetpass.php?utype=admin&empcode='.$_REQUEST['empcode'].'>Reset Password</a>';
							}	
						}
					?>
